...
class FieldBuilderTest extends TestCase
{
    ...
    {
        $test = $this->builder->makeCustomFile(
            'avatar', null, [
            'attributes' => [
                'id' => 'Avatar',
                'class' => 'foo-class'
    ...
    {
        $test = $this->builder->makeTextarea(
            'avatar', null, [
            'attributes' => [
                'id' => 'Avatar',
                'class' => 'foo-class'
    ...
    {
        $test = $this->builder->makeCheckboxInline(
            'avatar', null, [
            'attributes' => [
                'id' => 'Avatar',
                'class' => 'foo-class'
    ...
    {
        $test = $this->builder->makeRadioInline(
            'avatar', null, [
            'attributes' => [
                'id' => 'Avatar',
                'class' => 'foo-class'
    ...
    {
        $test = $this->builder->makeCheckInput(
            'avatar', null, [
            'type' => 'radio',
            'label' => 'foo',
            'attributes' => [
    ...
    {
        $test = $this->builder->makeCheckbox(
            'avatar', null, [
            'attributes' => [
                'id' => 'Avatar',
                'class' => 'foo-class'
    ...
    public function testMakeRelationshipWithNone()
    {
        ...
        $test = $this->builder->makeRelationship(
            'avatar', null, [
            'model' => Job::class,
